...
public class VersionedFile {
    ...
    static VersionedFile create(File path, byte[] content) throws IOException {
        if (path.exists()) {
            throw new IOException("File already exists: " + path);
        }
        Path dir = Files.createDirectory(path.toPath());
    ...
    public static void main(String[] args) throws IOException, DiffException {
        ...
        VersionedFile vf = VersionedFile.create(tempDir.resolve("test.file").toFile(), "Just Testing".getBytes());
